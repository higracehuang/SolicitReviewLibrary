...
struct AlertPreview: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        ...
        let yesAction = UIAlertAction(title: yesButtonTitle, style: .default, handler: nil)
...
struct AlertPreview_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            // Simplified Chinese
            AlertPreview(
                promptTitle: String(format: NSLocalizedString("Are you enjoying %@?", bundle: .moduleBundle, comment: ""), "TestApp"),
                promptMessage: NSLocalizedString("Please let us know what you think!", bundle: .moduleBundle, comment: ""),
                yesButtonTitle: NSLocalizedString("Love it! 🥰", bundle: .moduleBundle, comment: ""),
                noButtonTitle: NSLocalizedString("Not really", bundle: .moduleBundle, comment: "")
            )
